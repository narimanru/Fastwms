...
export function MarkingSafe() {
  return (
    <section className="bg-gradient-to-b from-white to-gray-50 py-16 sm:py-20 md:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
        {/* Header */}
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 text-white rounded-full text-[13px] font-medium mb-6 text-[#fefefe]">
            <Shield className="w-4 h-4" strokeWidth={2} />
            Маркировка
          </div>
          <h2 className="text-[32px] sm:text-[36px] md:text-[40px] font-semibold text-gray-900 mb-4 sm:mb-6 leading-tight"><span className="font-bold">Сейф для кодов маркировки (КИЗ</span><span className="font-bold">/DataMatrix)</span></h2>
          <p className="text-[17px] sm:text-[18px] md:text-[19px] text-gray-600 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-[24px] sm:text-[28px] md:text-[32px] font-semibold text-gray-900 mb-3 text-center">
            ...
            <div className="space-y-8 sm:space-y-10">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <h4 className="text-[17px] sm:text-[18px] font-semibold text-gray-900 mb-2">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <h4 className="text-[17px] sm:text-[18px] font-semibold text-gray-900 mb-2">Загрузили в FASTWMS (PDF/CSV) — проверка файла</h4>
                  <p className="text-[14px] sm:text-[15px] text-gray-600 leading-relaxed">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-[14px] sm:text-[15px] text-gray-600 leading-relaxed">Коды автоматически распределяются по товарным позициям и размерам</p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-[14px] sm:text-[15px] text-gray-600 leading-relaxed">Фулфилмент получает доступ к кодам для печати этикеток.                  <span className="font-bold">Печать кодов маркировки с настраиваемыми шаблонами и объединением этикеток товара и Честного Знака. Одна этикетка содержит всё сразу — меньше печати, меньше расходников и меньше ошибок при маркировке.</span></p>
                </div>
              </div>
